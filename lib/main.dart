...
import 'package:task_tracker/models/color_button.dart';
import 'package:task_tracker/models/task_tile.dart';
import 'package:task_tracker/models/task.dart';
import 'package:task_tracker/models/time_selector.dart';
import 'package:task_tracker/reminder.dart';
import 'file.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(debugShowCheckedModeBanner: false, home: MainList());
  }
}
...
class _MainListState extends State<MainList> {
  ...
  void loadFromDisk() async {
    ...
    if (data != null) {
      setState(() {
        for (var i in data) myList.add(Task.fromJson(i));
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            title: Text('Task Tracker', style: TextStyle(color: Colors.white)),
            actions: [
              IconButton(
                        ...
                        showDialog(
                          ...
                          builder: (context) => AlertDialog(
                            ...
                            content: TextField(
                              ...
                              decoration:
                                  InputDecoration(hintText: myList[i].title),
                            ),
                            actions: [
                              TextButton(
                                //cancel button
  ...
  showAlertDialog(BuildContext context) {
    ...
    Widget okButton = TextButton(
        child: Text("Ok"),
        onPressed: () {
          if (_portions == null || _portions == 0) _portions = 10;
          setState(() {
            ...
            myList.add(Task(
                ...
                reminderHour: _switch ? _time.hour : null,
                reminderMinute: _switch ? _time.minute : null));
            if (_switch)
              scheduleDailyNotification(
                  reminderId, mytext, _time.hour, _time.minute);
            saveFile('content', myList);
